# Required pip install packages: pandas matplotlib seaborn nltk scikit-learn
import pandas as pd
import numpy as np
...
plt.ylabel('')
plt.savefig('pie_chart.png') # Save to view easily
plt.show()
...
plt.ylabel('Words')
plt.savefig('bar_chart.png') # Save to view easily
plt.show()
...
plt.savefig('confusion_matrix.png') # Save to view easily
plt.show()
